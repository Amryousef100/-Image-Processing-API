...
describe('Test endpoint responses', function () {
    ...
    it('gets the api endpoint to work with values of query Pramters', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/api/images?fileName=fjord&width=500&height=500')];
                case 1:
                    response = _a.sent();
                    expect(response.status).toBe(200);
                    return [2 /*return*/];
...
describe('Test prossesing for images', function () {
    it('gets the prossesed image ', function () { return __awaiter(void 0, void 0, void 0, function () {
        var callback;
        return __generator(this, function (_a) {
            callback = function (path) {
                expect(path).toEqual(processedImagesPath);
            };
            (0, imagesResizeProcessApp_1.default)(imagePathBeforeProcessing, processedImagesPath, width, height, callback);
            return [2 /*return*/];
        });
    }); });
});
